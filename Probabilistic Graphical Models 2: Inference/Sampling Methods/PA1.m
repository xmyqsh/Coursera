...
[G, F] = ConstructToyNetwork(1.0, 1.0);
...
A1 = ones(1,16);
A2 = A1 * 2;
[M1,all_samples1] = MCMCInference(G, F, E, TransName, mix_time, num_samples, sampling_interval, A1);
[M2,all_samples2] = MCMCInference(G, F, E, TransName, mix_time, num_samples, sampling_interval, A2);
samples_list{1} = all_samples1;
samples_list{2} = all_samples2;

%VisualizeMCMCMarginals(samples_list, [1 : 16], G.card, F, 100, 'PA1')
VisualizeMCMCMarginals(samples_list, [1], G.card, F, 100, 'PA1')
