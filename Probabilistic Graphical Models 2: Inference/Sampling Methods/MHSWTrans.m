...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
logp_new = LogProbOfJointAssignment(F, A_prop);
logp_old = LogProbOfJointAssignment(F, A);
% proposal distribution is symmetric from uniform distribution
p_acceptance = min(1, exp(logp_new - logp_old + log_QY_ratio + LogR(old_value) - LogR(new_value)));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
